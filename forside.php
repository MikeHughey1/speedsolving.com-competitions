...
END;
        ...
        $personInfo = get_person_info($_SESSION['logged_in']);
...
END;
    ...
    This system was aired on 4th January 2012 and so far it takes care of more than 2800 users.<br>
    So far these users have posted <b>over 160,000 results</b> and they have altogether solved around <b>500,000 puzzles</b>!<br><br>
